...
values = initvalues
labels = ["South Africa", "Egypt", "Nigeria", "Algeria", "Morocco", "Angola", "Libya", "Tunisia", "Kenya", "Ethiopia", "Ghana", "Gameron"]

colors = [(214, 27,31), (229, 109, 0), (109, 178, 2), (50, 155, 18), (41, 127, 214), (27, 70, 163), (72, 17, 121), (209, 0, 89), (148, 0, 26), (223, 44, 13), (195, 215, 0)]

# Scale the RGB values to the [0,1] range, which is the format maplotlib accepts.
...
# padded rectangles will probably visulize better for certain cases
...
for l, r, v in zip(labels, rects, initvalues):
	...
	ax.text(x+dx/2, y+dy/2+10, str(idx)+"--> "+l, va=va, ha='center', color='white', fontsize=12)
	idx += 1
